                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        <form role="form" action="{{ URL::to('/save-product') }}" method="post"
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">giá tiền nhập</label>
                                <input type="text" name="product_import_price" class="form-control" id="exampleInputEmail1"
                                    placeholder="Tên danh mục">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Số lượng sản phẩm</label>
                                <input type="text" name="product_number" class="form-control" id="exampleInputEmail1"
                                    placeholder="Tên danh mục">
                            </div>
