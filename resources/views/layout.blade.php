                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{ URL::to('/') }}"><img src="{{ asset('public/frontend/images/logo.png') }}"
                                    alt="" /></a>
                        </div>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ 'public/frontend/images/101.webp' }}" class="girl img-responsive"
                                        alt="" />
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ 'public/frontend/images/102.webp' }}" class="girl img-responsive"
                                        alt="" />
                                    <img src="{{ 'public/frontend/images/pricing.png' }}" class="pricing" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ 'public/frontend/images/103.webp' }}" class="girl img-responsive"
                                        alt="" />
                                    <img src="{{ 'public/frontend/images/pricing.png' }}" class="pricing" alt="" />
                                </div>
                            </div>
                    ...
                    <div class="col-sm-7">
                            ...
                            <div class="video-gallery text-center">
                                <a href="https://youtube.com/watch?v=j3UGfKykJWE&t=5s&ab_channel=KênhĐồngHồHảiTriều">
                                    <div class="iframe-img">
                                        <img src="{{ 'public/frontend/images/101.webp' }}" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="https://youtube.com/watch?v=j3UGfKykJWE&t=5s&ab_channel=KênhĐồngHồHảiTriều">
                                    <div class="iframe-img">
                                        <img src="{{ 'public/frontend/images/102.webp' }}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="https://youtube.com/watch?v=j3UGfKykJWE&t=5s&ab_channel=KênhĐồngHồHảiTriều">
                                    <div class="iframe-img">
                                        <img src="{{ 'public/frontend/images/103.webp' }}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="https://youtube.com/watch?v=j3UGfKykJWE&t=5s&ab_channel=KênhĐồngHồHảiTriều">
                                    <div class="iframe-img">
                                        <img src="{{ 'public/frontend/images/104.webp' }}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
